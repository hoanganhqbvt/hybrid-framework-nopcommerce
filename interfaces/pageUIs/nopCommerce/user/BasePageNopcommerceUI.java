...
public static final String DYNAMIC_LINK_ON_TOP_MENU = "xpath=//ul[@class='top-menu notmobile']//a[contains(text(),'%s')]";
public static final String DYNAMIC_SUBLINK_PAGE_BY_NAME = "xpath=//ul[@class='sublist']//a[contains(text(),'%s')]";
