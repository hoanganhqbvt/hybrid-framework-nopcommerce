...
public class Level_02_Apply_BasePage_III extends BasePage {
  ...
  public void TC_02_Register_Invalid_Email() {
	  ...
	  sendkeyToElement(driver, "//input[@id='LastName']", "Smith");	  
	  sendkeyToElement(driver, "//input[@id='Email']", "abc#123.123");	  
	  sendkeyToElement(driver, "//input[@id='Password']", "Abc@12345678");	  
	  sendkeyToElement(driver, "//input[@id='ConfirmPassword']", "Abc@12345678");
	  waitForElementClickable(driver, "//button[@id='register-button']");
	  clickToElement(driver, "//button[@id='register-button']");
  ...
  public void TC_06_Register_Invalid_Confirm_Password() {
	  ...
	  sendkeyToElement(driver, "//input[@id='ConfirmPassword']", "Abc@132");
	  waitForElementClickable(driver, "//button[@id='register-button']");
	  clickToElement(driver, "//button[@id='register-button']");
