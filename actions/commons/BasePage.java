...
public class BasePage {
	...
	protected void closeAllTabsExceptParentByID(WebDriver driver, String parentTabID) {
		Set<String> allWindowIDs = driver.getWindowHandles();
		for (String id : allWindowIDs) {
	...
	protected void closeAllTabsExceptParentByTitle(WebDriver driver, String parentTabTitle) {
