...
public class BasePage {
	...
	private By getByLocator(String locatorType) {
		...
		if (locatorType.startsWith("id=") || locatorType.startsWith("ID=") || locatorType.startsWith("Id=")) {
			by = By.id(locatorType.substring(3));
				...
				|| locatorType.startsWith("Class=") || locatorType.startsWith("CLass=")) {
	...
	public void selectItemInCustomDropdownNotUseJS(WebDriver driver, String parentXpath, String childXpath,
			String expectedTextItem) {
		getWebElement(driver, parentXpath).click();
		sleepInSecond(1);
		WebDriverWait explicitWait = new WebDriverWait(driver, longTimeout);
	...
	public void selectItemInCustomDropdown(WebDriver driver, String parentXpath, String childXpath,
			String expectedTextItem, String... jobDropdownLabel) {

		getWebElement(driver, parentXpath, jobDropdownLabel).click();
		sleepInSecond(1);
		WebDriverWait explicitWait = new WebDriverWait(driver, longTimeout);
		explicitWait.until(ExpectedConditions
				.visibilityOfAllElements(getListWebElement(driver, getDynamicXpath(childXpath, jobDropdownLabel))));
	...
	public String getElementCssValue(WebDriver driver, String locatorType, String propertyName,
			String... dynamicValues) {
		return getWebElement(driver, locatorType, dynamicValues).getCssValue(propertyName);
	}
	...
	public void openTopMenuLinkPageByName(WebDriver driver, String pageName) {
		waitForElementVisible(driver, BasePageNopcommerceUI.DYNAMIC_LINK_ON_TOP_MENU, pageName);
		clickToElement(driver, BasePageNopcommerceUI.DYNAMIC_LINK_ON_TOP_MENU, pageName);
	}

	public void openSubLinkPageByName(WebDriver driver, String subPageName) {
		waitForElementVisible(driver, BasePageNopcommerceUI.DYNAMIC_SUBLINK_PAGE_BY_NAME, subPageName);
		clickToElement(driver, BasePageNopcommerceUI.DYNAMIC_SUBLINK_PAGE_BY_NAME, subPageName);
	}
